                      ...
                      >
                        <div className="gi-product-content pb-[24px] h-full flex">
                          <div className="gi-product-inner transition-all duration-[0.3s] ease-in-out cursor-pointer flex flex-col overflow-hidden border-[1px] border-solid border-[#eee] rounded-[5px]">
                            <div className="gi-pro-image-outer transition-all  z-[11] relative">
                              <div className="gi-pro-image overflow-hidden">
                                ...
                                >
                                  ...
                                  <img
                                    className="main-image  max-w-full transition-all "
                                    src={items.image}
                                    alt="Product"
                                  />
                                  <img
                                    className="hover-image absolute top-0 left-0 w-full transition-all "
                                    src={items.image}
                                    alt="Product"
                                  />
                                </Link>

...
function Testimonial() {
  ...
  return (
    <>
      <div className="  lg:p-12 p-4  min-h-40 relative overflow-hidden">
        <img
          src={circleimage}
          alt=""
        ...
        />
        <div className="max-w-7xl max-md:max-w-lg mx-auto z-50">
          ...
          <Slider
            {...settings}
            className="testimonial-slider w-[90%]  mx-auto p-8"
          >

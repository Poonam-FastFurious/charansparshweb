...
import banner from "../../assets/Images/contactUs.jpeg";
...
function Contactus() {
  ...
  return (
    <>
      ...
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-24">
        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <ul className="mt-16 space-y-8">
              <li className="flex items-center">
                ...
                <Link to="#" className="text-sm text-white ml-4">
                  info@charansparsh.in
                </Link>
              </li>
              <li className="flex items-center">
                <svg
              ...
              <li className="flex items-center">
                ...
                <Link to="#" className=" text-sm text-white ml-4">
                  E-New Bharat Services Pvt. Ltd. <br />
                  301-303, Suncity Trade Tower, <br />
                  Sector 21, Gurugram, Haryana-122016
                </Link>
              </li>
            </ul>
            ...
            <ul className="flex flex-wrap gap-4 mt-16">
              <li className="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link to="https://www.facebook.com/charansparshfoundation">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18px"
                    height="18px"
              ...
              <li className="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link to="https://www.linkedin.com/company/charan-sparsh">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18px"
                    height="18px"
              ...
              <li className="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link to="https://www.instagram.com/charansparshfoundation">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18px"
                    height="18px"
          ...
          <div className="p-4 lg:col-span-2">
            <form>
              ...
              <button
                type="button"
                className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide  bg-orange-400 "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
